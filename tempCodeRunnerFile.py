...
class EmotionGUI:
    ...
    def start_dass_test(self):
        ...
        self.questions = [
            ...
            "I was worried about situations in which I might panic.", "I found it difficult to relax.",
            "I felt down-hearted and blue.", "I was intolerant of anything that kept me from getting on with things.",
            "I felt I was close to panic.", "I found it difficult to work up the initiative to do things.",
            "I was unable to become enthusiastic about anything.", "I felt I wasn’t worth much as a person.",
            "I felt that life was meaningless.", "I felt that I was rather touchy.",
            "I found it hard to calm down after something upset me.", "I was unable to become enthusiastic about anything.",
    ...
    def create_emoji_selection(self):
        ...
        Label(self.emoji_window, text=f"Select 3 Emojis (Phase {self.emoji_phase + 1}/3)", font=("Arial", 14)).pack(pady=10)
        ...
        def select_emoji(emoji, button):
            ...
            elif len(self.selected_phase_emojis) < 3:
    ...
    def next_emoji_phase(self):
        if len(self.selected_phase_emojis) != 3:
            return  # Ensure exactly 3 emojis are selected
